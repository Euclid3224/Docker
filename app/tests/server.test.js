...
test("frontend keeps public admin links hidden and uses local hero assets", async () => {
  ...
  assert.match(menuHtml, /class="menu-category-list"/);
  assert.match(menuHtml, /data-category="bread"/);
  assert.match(menuHtml, /data-search-toggle/);
  assert.match(menuHtml, /data-product-search/);
  assert.match(menuHtml, /assets\/nav-cart\.svg/);
  assert.match(menuHtml, /data-build="20260614-menu-redesign-v1"/);
  assert.match(menuHtml, /catalog\.js\?v=20260614-menu-redesign-v1/);
